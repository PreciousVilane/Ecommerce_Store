...
SECRET_KEY = "django-insecure-m%*yo#v*=tvobpt3-f-!^3*ay)ptw1&g5p-bod26ofx))-pa_e"
...
# Development: emails will appear in the console
...
DATABASES = {
    "default": {
        ...
        "NAME": "test_ecommerce_db",  # i changed the name from"db.sqlite3"
        "USER": "root",
...
STATICFILES_DIRS = [BASE_DIR / "static"]  # optional, your dev static folder
